...
* **JavaScript (ES6+):** Lógica interactiva e integración del carrito de compras.
* **React:** Librería planificada para la fase de escalabilidad del front-end.
...
* **Revisión Obligatoria:** Ningún cambio se fusiona directamente a `main` sin pasar por un *Pull Request* revisado y aprobado por otro integrante.
...
3. **Revisión de Pares:** Al menos una observación específica y útil realizada por el revisor.
4. **Verificación en Local:** Confirmar que la estructura HTML/CSS/JS no contenga errores de sintaxis antes de subir.
5. **Aprobación Completa:** Pull Request corregido, aprobado y listo para realizar el *merge* a `main`.
